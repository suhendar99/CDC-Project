                            ...
                            <form action="{{route('bulky.pemesanan.keluar.store')}}" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-6">
                                        ...
                                        <select name="barang_kode" id="barang" class="form-control">
                                            ...
                                            <option value="{{ $barang->kode_barang }}" data-satuan="{{ $barang->satuan }}">{{ $barang->kode_barang }} | {{ $barang->nama_barang }}</option>
                                            @endforeach
                                        </select>
                                        @error('barang_kode')
                                            <span class="invalid-feedback" role="alert">
                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="numeric" class="form-control @error('telepon') is-invalid @enderror" name="telepon" value="{{ old('telepon') }}">
                                        @error('telepon')
                                              <span class="invalid-feedback" role="alert">
                                                  <strong>{{ $message }}</strong>
                                              </span>
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="alamat_pemesan" class="form-control">{{ old('alamat_pemesan') }}</textarea>
