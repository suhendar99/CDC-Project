                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="float-right">
                                <a href="{{route('pesanan.create')}}" class="btn btn-primary btn-sm">Tambah Pemesanan</a>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-12 d-flex justify-content-between valign-center my-2">
                                    <a href="{{route('pesanan.preview',$d->id)}}" class="btn btn-sm bg-my-primary">Lihat Detail</a>
                                    <div>
                                        @if($d->status == 0)
