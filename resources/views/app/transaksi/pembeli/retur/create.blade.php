                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="float-right">
                                <a href="{{route('retur-pembeli.index')}}" class="btn btn-primary btn-sm">Kembali</a>
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <form action="{{route('retur-pembeli.store')}}" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-6">
                                        ...
                                        <select name="barang_warung_kode" id="" class="form-control">
                                            ...
                                            @foreach ($barang as $b)
                                                <option value="{{$b->pemesananPembeliItem[0]->barang_warung_kode}}" {{ old('barang_warung_kode') == $b->pemesananPembeliItem[0]->barang_warung_kode ? 'selected' : ''}}>{{$b->pemesananPembeliItem[0]->nama_barang}}</option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <select name="pemesanan_pembeli_id" id="" class="form-control">
                                            ...
                                            @foreach ($barang as $pesan)
                                                <option value="{{$pesan->id}}" {{ old('pemesanan_pembeli_id') == $pesan->id ? 'selected' : ''}}>{{$pesan->nomor_pemesanan}}</option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="form-group">
                                  ...
                                  <div class="row">
                                      <div class="col-md-12">
                                        <div class="float-right">
                                            <button type="submit" class="btn btn-success btn-sm">Kirim Retur</button>
                                        </div>
                                      </div>
                                  </div>
                            </form>
