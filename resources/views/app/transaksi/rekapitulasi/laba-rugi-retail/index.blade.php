@php
        $icon = 'storage';
        $pageTitle = 'Data Laba Rugi Retail';
@endphp
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="float-right">
                                <a href="{{route('retail.laba-rugi.create')}}" class="btn btn-primary btn-sm">Buat Data Laba Rugi</a>
                            </div>
                        </div>
                    </div>
                </div>
...
@push('script')
    <script>
        ...
        function sweet(id){
            ...
            formDelete.action = '/v1/retail/laba-rugi/'+id
