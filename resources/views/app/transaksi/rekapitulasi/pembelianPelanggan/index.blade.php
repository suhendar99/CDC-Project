    ...
    <div class="col-md-8 col-sm-12 valign-center py-2">
        ...
        <div>
          ...
          <div class="valign-center breadcumb">
            ...
            <i class="material-icons md-14 px-2">keyboard_arrow_right</i>
            <a href="#" class="text-14">Laporan Pembelian Barang</a>
          </div>
        </div>
    </div>
...
<div class="modal fade" id="modalLaporanPdf" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <form action="{{route('print-rekapitulasiPembelianPelanggan-pdf')}}" target="__blank" method="post">
...
<div class="modal fade" id="modalLaporanExcel" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <form action="{{route('print-rekapitulasiPembelianPelanggan-excel')}}" target="__blank" method="post">
            <div class="modal-body">
                @csrf
                <div class="row">
                    <div class="col-md-12">
...
<script type="text/javascript">
    let table = $('#data_table').DataTable({
            ...
            ordering : false,
            pageLength : 10,
            ajax : "{{ route('rekapitulasiPembelianPelanggan.index') }}",
            columns : [
        ...
        function sweet(id){
            ...
            formDelete.action = '/v1/rekapitulasiPenjualanPelanggan/'+id
