@php
        $icon = 'book';
        $pageTitle = 'Rekapitulasi Pembelian Barang Bulky';
        $dashboard = true;
        // $rightbar = true;
@endphp
    ...
    <div class="col-md-12 col-sm-12 valign-center py-2">
        ...
        <div>
          ...
          <div class="valign-center breadcumb">
            ...
            <i class="material-icons md-14 px-2">keyboard_arrow_right</i>
            <a href="#" class="text-14">Data Rekapitulasi Pembelian Barang Bulky</a>
          </div>
        </div>
    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="float-right">
                                <a href="{{route('bulky.rekap.pembelian.pdf')}}" class="btn btn-primary btn-sm" target="__blank"><i class="far fa-file-pdf"></i> Download PDF</a>
                                <a href="{{route('bulky.rekap.pembelian.excel')}}" class="btn btn-primary btn-sm" target="__blank"><i class="far fa-file-excel"></i> Download EXCEL</a>
                            </div>
                        </div>
                    </div>
                </div>
...
<script type="text/javascript">
    let table = $('#data_table').DataTable({
            ...
            ordering : false,
            pageLength : 10,
            ajax : "{{ route('bulky.rekap.pembelian.index') }}",
            columns : [
