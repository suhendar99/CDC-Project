        ...
        function bukti(id){
            ...
            $.ajax({
                ...
                success: (response)=>{
                    ...
                    $('#jumlah_uang').val(response.data[0].harga);
                    $('#verifikasi').attr('action','/v1/validasi/bukti/pembeli/'+id)
                    $('#tidakSesuai').attr('href','/v1/tidakSesuai/pesanan/pembeli/'+id)
                    // $('#tolak').attr('href','/v1/tolak/pesanan/bulky/'+id)
                    if (response.data[0].pemesanan_pembeli.status == 2 || response.data[0].pemesanan_pembeli.status == 0 || response.data[0].pemesanan_pembeli.status == 5 || response.data[0].pemesanan_pembeli.status == 4 || response.data[0].pemesanan_pembeli.status == 3 ) {
                    ...
                    $('.rp').addClass('d-none');
                    } else if (response.data[0].pemesanan_pembeli.status == 1 || response.data[0].pemesanan_pembeli.status == 7) {
