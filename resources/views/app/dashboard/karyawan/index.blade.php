...
<div class="row my-4">
    <div class="col-12 d-flex">
      <i class="material-icons md-24 text-my-warning mr-2">work</i><span style="font-size: 18px">Daftar Barang Bulky</span>
    </div>
    <div class="col-12">
...
<div class="row my-4">
    <div class="col-12 d-flex">
      <i class="material-icons md-24 text-my-warning mr-2">work</i><span style="font-size: 18px">Daftar Barang Retail</span>
    </div>
    <div class="col-12">
        <div class="MultiCarousel" data-items="1,3,5,6" data-slide="1" id="MultiCarousel"  data-interval="1000">
            <div class="MultiCarousel-inner">
