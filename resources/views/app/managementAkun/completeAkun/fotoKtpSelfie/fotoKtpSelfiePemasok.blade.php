                                    ...
                                    <div class="card shadow">
                                        <div class="card-header">
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="float-left">
                                                        <a href="javascript:void(0)" data-toggle="modal" data-target="#exampleModalCenter"> Contoh foto</a>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="exampleModalLongTitle">Contoh Foto Selfie KTP</h5>
