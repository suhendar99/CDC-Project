                    ...
                    <div class="row">
                        <div class="card-body">
                                        ...
                                        <div class="card-body">
                                            <div class="row">
                                                <div class="col-md-12 justify-content-center">
                                                    <small class="text-danger"> Pastikan tulisan dapat terbaca dengen jelas dan foto tidak kabur(blur)</small>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="float-right">
                                        <form action="{{route('foto.ktp',Auth::user()->id)}}" method="post" enctype="multipart/form-data">
                                            @csrf
                                            <input type="hidden" name="foto_ktp" id="foto-ktp" required>
                                            <div class="row">
                                                <div class="col-md-12">
                                                  <div class="float-right">
