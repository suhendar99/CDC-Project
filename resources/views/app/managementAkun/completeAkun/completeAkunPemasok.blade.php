                    ...
                    <div class="row">
                        <div class="col-md-12 col-sm-6">
                            <form action="{{route('complete.akun',$auth->id)}}" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    <div class="col-md-12">
                                        <label>Jenis Kelamin <small class="text-success @error('jenis_kelamin') is-invalid @enderror">*Harus diisi</small></label>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <div class="col-md-12">
                                                <label>Agama <small class="text-success">*Harus dipilih</small></label>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <div class="col-md-12">
                                                <label>Status Perkawinan <small class="text-success">*Harus dipilih</small></label>
