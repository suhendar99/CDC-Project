@php
        $icon = 'book';
        $pageTitle = 'Rekapitulasi Stok Barang Retail';
        $dashboard = true;
        // $rightbar = true;
@endphp
...
<div class="modal fade" id="modalLaporanPdf" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <form action="{{route('laporan.barang.pdf')}}" target="__blank" method="post">
...
<div class="modal fade" id="modalLaporanExcel" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <form action="{{route('laporan.barang.excel')}}" target="__blank" method="post">
            <div class="modal-body">
                @csrf
                <div class="row">
                    <div class="col-md-12">
...
<script type="text/javascript">
    let table = $('#data_table').DataTable({
            ...
            ordering : false,
            pageLength : 10,
            ajax : "{{ route('laporan.barang') }}",
            columns : [
                {data : 'DT_RowIndex', name: 'DT_RowIndex', searchable:false,orderable:false},
                {data : 'created_at', name: 'created_at'},
                {data : 'gudang', name: 'gudang'},
                {data : 'stock_barang_bulky.barang_kode', name: 'barang_kode'},
                {data : 'nama', name: 'nama'},
