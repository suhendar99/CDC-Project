                ...
                <div class="card-body ">
                    <div class="row">
                        <div class="col-md-12 col-sm-6">
                            <form action="{{route('laporan.barang.masuk.pdf')}}" id="actionLaporan" method="post" enctype="multipart/form-data">
                                @csrf
                                <div class="row">
                                    <div class="col-md-6">
                                ...
                                <div class="row">
                                    ...
                                    <div class="float-right">
                                        <button type="submit" class="btn btn-success btn-sm"> Buat Laporan</button>
                                    </div>
                                    </div>
                                </div>
                            </form>
