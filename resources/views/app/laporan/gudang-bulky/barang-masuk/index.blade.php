                ...
                <div class="card-body ">
                    <div class="row">
                        <div class="col-md-12 col-sm-6">
                            <form action="{{route('bulky.laporan.barang.masuk.pdf')}}" target="__blank" id="actionLaporan" method="post" enctype="multipart/form-data">
                                @csrf
...
<script type="text/javascript">
    const formExcel = ()=>{
        ...
        pdf.addEventListener('click', e=>{
            ...
            actionForm.action = "{{ route('bulky.laporan.barang.masuk.pdf') }}";
        ...
        excel.addEventListener('click', e=>{
            ...
            actionForm.action = "{{ route('bulky.laporan.barang.masuk.excel') }}";
            console.log(actionForm.action);
        });
    }
    formExcel();
