    ...
    <div class="col-md-8 col-sm-12 valign-center py-2">
        ...
        <div>
          ...
          <div class="valign-center breadcumb">
            ...
            <i class="material-icons md-14 px-2">keyboard_arrow_right</i>
            <a href="#" class="text-14">Penjualan</a></div>
        </div>
    </div>
                ...
                <div class="card-body ">
                    <div class="row">
                        <div class="col-md-12 col-sm-6">
                            <form action="{{route('bulky.laporan.barang.keluar.pdf')}}" target="__blank" id="actionLaporan" method="post" enctype="multipart/form-data">
                                @csrf
...
<script type="text/javascript">
    const formExcel = ()=>{
        ...
        pdf.addEventListener('click', e=>{
            ...
            actionForm.action = "{{ route('bulky.laporan.barang.keluar.pdf') }}";
        });
        excel.addEventListener('click', e=>{
            if(pdf.checked == true){
                pdf.checked = false;
            }
            actionForm.action = "{{ route('bulky.laporan.barang.keluar.excel') }}";
        });
    }
    formExcel();
