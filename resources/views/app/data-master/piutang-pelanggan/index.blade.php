                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="float-right">
                                <a href="{{route('piutangPelanggan.pdf')}}" class="btn btn-primary btn-sm" target="__blank"><i class="far fa-file-pdf"></i> Download PDF</a>
                                <a href="{{route('piutangPelanggan.excel')}}" class="btn btn-primary btn-sm" target="__blank"><i class="far fa-file-excel"></i> Download EXCEL</a>
                            </div>
                        </div>
                    </div>
                </div>
