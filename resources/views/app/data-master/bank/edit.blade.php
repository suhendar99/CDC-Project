    ...
    <div class="col-md-8 col-sm-12 valign-center py-2">
        ...
        <div>
          ...
          <div class="valign-center breadcumb">
            ...
            <i class="material-icons md-14 px-2">keyboard_arrow_right</i>
            <a href="#" class="text-14">Edit Data Bank</a>
          </div>
        </div>
    </div>
                            ...
                            <form action="{{route('bank.update', $data->id)}}" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-4">
                                        ...
                                        <input type="text" class="form-control @error('nama_bank') is-invalid @enderror" name="nama_bank" value="{{ $data->nama }}" aria-describedby="barangStatus" placeholder="Enter the bank name...">
                                        @error('nama_bank')
                                    ...
                                    <div class="form-group col-md-4">
                                        ...
                                        <select name="tahun_berdiri" id="" class="form-control">
                                            ...
                                            @for($i = 1945;$i <= 2021;$i++)
                                                <option value="{{ $i }}" @if($data->tahun_berdiri == $i) selected @endif>{{ $i }}</option>
                                            @endfor
                                        </select>
                                        @error('tahun_berdiri')
                                            <span class="invalid-feedback" role="alert">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control @error('telepon') is-invalid @enderror" name="telepon" value="{{ $data->telepon }}" placeholder="Enter number...">
                                    @error('telepon')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="alamat" rows="3" class="form-control @error('alamat') id-invalid @enderror" >{{ $data->alamat }}</textarea>
                                    @error('alamat')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
