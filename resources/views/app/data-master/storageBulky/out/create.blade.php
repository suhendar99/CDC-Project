    ...
    <div class="row h-100">
        <div class="col-md-12">
            <div class="card card-block d-flex" id="card-form">
                ...
                <form action="{{route('bulky.storage.keluar.store')}}" method="post" enctype="multipart/form-data" id="form-tag">
                    @csrf
                    <div class="card-body ">
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="tab" data-keterangan="Pilih Pemesanan Untuk Barang Keluar">
                                    <div class="form-group">
                                        ...
                                        <select id="selectSatuan" class="form-control @error('pemesanan_bulky_id') is-invalid @enderror" name="pemesanan_bulky_id" placeholder="Enter pemesanan_bulky_id">
