                ...
                <div class="card-body ">
                    <div class="row">
                        <div class="col-md-12 col-sm-6">
                            <form action="{{route('surat-piutang-retail-bulky.store')}}" method="post" enctype="multipart/form-data">
                                @csrf
                                <input type="hidden" name="jumlah_uang_digits" id="jumlah_uang" value="{{$data->pemesananBulky->barangPesananBulky->harga}}">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <div class="col-md-16">
                                                ...
                                                <input type="text" class="form-control @error('pihak_pertama') is-invalid @enderror" name="pihak_pertama" value="{{ $data->pemesananBulky->penerima_po }}">
                                                @error('pihak_pertama')
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <div class="col-md-16">
                                                ...
                                                <input type="text" class="form-control @error('pihak_kedua') is-invalid @enderror" name="pihak_kedua" value="{{ $data->pemesananBulky->nama_pemesan }}">
                                                @error('pihak_kedua')
                                                    <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $message }}</strong>
                                                    </span>
...
<script type="text/javascript">
    var digit =  JSON.parse('{!! json_encode($data->pemesananBulky->barangPesananBulky->harga) !!}')
    console.log(digit);
