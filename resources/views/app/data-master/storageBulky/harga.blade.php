@php
        $icon = 'storage';
        $pageTitle = 'Atur Harga Barang '.$data->barang->nama_barang.' Di Gudang Bulky '.$data->bulky->nama;
@endphp
                ...
                <div class="card-body ">
                    <div class="row">
                          ...
                          <table class="table table-bordered">
                            <thead class="thead-dark">
                                <tr>
                                    ...
                                    <th>Jumlah Barang</th>
                                    <th>Harga Beli</th>
                                    <th>Harga Dasar Per-{{ ($base_harga->satuan == 'Ton') ? 'Kuintal' : $base_harga->satuan }}</th>
                                    <th>Ambil Untung</th>
                                    <th>Harga Jual Per-{{ ($base_harga->satuan == 'Ton') ? 'Kuintal' : $base_harga->satuan }}</th>
                                </tr>
                            </thead>
                        ...
                        <div class="col-md-12 col-sm-6">
                            <form action="{{route('bulky.harga.simpan', $id)}}" method="post" enctype="multipart/form-data">
                                @csrf
                                @method('PUT')
                                <div class="form-row">
                                    <div class="form-group col-md-6">
                                        <label>Harga Barang Per-{{ ($base_harga->satuan == 'Ton') ? 'Kuintal' : $base_harga->satuan }} <small class="text-success">*Harus diisi</small></label>
                                        <div class="input-group">
                                            <div class="input-group-append">
