                            ...
                            <form action="{{route('bulky.harga.simpan', $id)}}" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <div class="input-group">
                                            <input type="numeric" id="diskon" class="form-control @error('diskon') is-invalid @enderror" name="diskon" value="{{ $diskon }}" aria-describedby="diskonR" placeholder="00.00" min="1" max="100">
                                            <div class="input-group-append">
