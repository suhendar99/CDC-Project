                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="float-left">
                                <form action="{{route('gudang-bulky.index')}}" method="get" style="width: 100%;">
                                    @csrf
                        ...
                        <div class="col-md-6">
                            <div class="float-right">
                                <a href="{{route('gudang-bulky.create')}}" class="btn btn-primary btn-sm">Tambah Data Gudang Bulky</a>
                            </div>
                        </div>
                    </div>
                </div>
...
<script type="text/javascript">
    ...
    //     });
        ...
        function sweet(id){
            ...
            formDelete.action = '/v1/gudang-bulky/'+id
