@php
        $icon = 'storage';
        $pageTitle = 'Data Pengurus Gudang Bulky';
@endphp
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="float-right">
                                <a href="{{route('bulky.pengurus.create')}}" class="btn btn-primary btn-sm">Tambah Pengurus</a>
                            </div>
                        </div>
                    </div>
                </div>
...
@push('script')
    <script>
        let table = $('#data_table').DataTable({
            ...
            ordering : false,
            pageLength : 10,
            ajax : "{{ route('bulky.pengurus.index') }}",
            columns : [
                {data : 'DT_RowIndex', name: 'DT_RowIndex', searchable:false,orderable:false},
                {data : 'pengurus_gudang_bulky.nama', name: 'name'},
                {data : 'username', name: 'username'},
                {data : 'email', name: 'email'},
                {
                  data : 'pengurus_gudang_bulky.bulky', render:function(data,a,b,c){
                        return data[0].nama;
                  }
                },
        ...
        function sweet(id){
            ...
            formDelete.action = '/v1/bulky/pengurus/'+id
