                ...
                <div class="card-body ">
                    <div class="row">
                        <div class="col-md-12 col-sm-6">
                            ...
                            <form action="{{route('gudang-bulky.store')}}" method="post" enctype="multipart/form-data">
                                @csrf
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-row">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-row">
                                            ...
                                            <div class="form-group col-md-6">
                                                ...
                                                <input type="text" min="1" class="form-control @error('pemilik') is-invalid @enderror" name="pemilik" value="{{ Auth::user()->pengurusGudangBulky->nama }}" placeholder="Enter pemilik">
                                                @error('pemilik')
                                                    <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $message }}</strong>
                                                    </span>
