@php
        $icon = 'storage';
        $pageTitle = 'Tambah Data Rekening Pemasok';
        $dashboard = true;
        // $rightbar = true;
@endphp
                ...
                <div class="card-body ">
                    <div class="row">
                        <div class="col-md-12 col-sm-6">
                            <form action="{{route('rekeningPemasok.store')}}" method="post" enctype="multipart/form-data">
                                @csrf
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <select name="bank_id" id="" class="js-example-basic-single form-control @error('bank_id') is-invalid @enderror">
                                            ...
                                            @foreach ($bank as $item)
                                                <option value="{{$item->id}}" {{ old('bank_id') == $item->id ? 'selected' : ''}}>{{$item->nama}}</option>
                                            @endforeach
                                        </select>
                                        @error('bank_id')
                                ...
                                <div class="form-group">
                                    <div class="col-md-12">
                                        ...
                                        <input type="text" class="form-control @error('pemilik') is-invalid @enderror" name="pemilik" value="{{ old('pemilik') }}" placeholder="Enter nama barang">
                                        @error('pemilik')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                ...
                                <div class="form-group">
                                    <div class="col-md-12">
                                        ...
                                        <input type="number" min="0" class="form-control @error('no_rek') is-invalid @enderror" name="no_rek" value="{{ old('no_rek') }}" placeholder="Enter nama barang">
                                        @error('no_rek')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
