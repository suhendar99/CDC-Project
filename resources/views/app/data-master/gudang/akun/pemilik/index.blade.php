    ...
    <div class="col-md-8 col-sm-12 valign-center py-2">
        ...
        <div>
          ...
          <div class="valign-center breadcumb">
            ...
            <i class="material-icons md-14 px-2">keyboard_arrow_right</i>
            <a href="#" class="text-14">Data Pemilik Gudang</a>
          </div>
        </div>
    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="float-right">
                                <a href="{{route('pemilik-gudang.create')}}" class="btn btn-primary btn-sm">Tambah Pemilik Gudang</a>
                            </div>
                        </div>
                    </div>
                </div>
...
@push('script')
    <script>
        let table = $('#data_table').DataTable({
            ...
            ordering : false,
            pageLength : 10,
            ajax : "{{ route('pemilik-gudang.index') }}",
            columns : [
        ...
        function sweet(id){
            ...
            formDelete.action = '/v1/pemilik-gudang/'+id
