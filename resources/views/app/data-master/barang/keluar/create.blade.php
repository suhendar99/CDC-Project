                    ...
                    <div class="row">
                        ...
                        <div class="col-md-2">
                            <div class="float-right">
                                <a href="{{route('storage-keluar-pemasok.index')}}" class="btn btn-primary btn-sm">Kembali</a>
                            </div>
                        </div>
                    </div>
                </div>
                <form action="{{route('storage-keluar-pemasok.store')}}" method="post" enctype="multipart/form-data" id="form-tag">
                    @csrf
                    <div class="card-body ">
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="tab" data-keterangan="Pilih Pemesanan Untuk Barang Keluar">
                                    <div class="form-group">
                                        ...
                                        <select id="selectSatuan" class="form-control @error('pemesanan_keluar_bulky_id') is-invalid @enderror" name="pemesanan_keluar_bulky_id">
                                            @if($setted == true)
                                        ...
                                        @error('pemesanan_keluar_bulky_id')
